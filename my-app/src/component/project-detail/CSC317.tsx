    ...
    return (
        ...
        >
            ...
            <div className='db ma br4 flex-row flex-nowrap justify-items-center tc bg-white-50 w-70 w-100-ns'>
                ...
                <button className='mh2 mv1 br3 bn tl bg-white-50 f4 f6-ns w-50 w-80-ns pointer' onClick={scrollToUser}>・Create a new user</button>
                <button className='mh2 mv1 br3 bn tl bg-white-50 f4 f6-ns w-50 w-80-ns pointer' onClick={scrollToPost}>・Create a new post</button>
                <button className='mh2 mv1 br3 bn tl bg-white-50 f4 f6-ns w-50 w-80-ns pointer' onClick={scrollToComment}>・Comment on the post</button>
                <button className='mh2 mv1 br3 bn tl bg-white-50 f4 f6-ns w-50 w-80-ns pointer' onClick={scrollToSearch}>・Search for the created post</button>
            ...
            <div className='db ma mh1 mv3 f3 f5-ns b dark-gray w-80' ref={userRef}>Create a new user</div>
            <div className='db ma flex-row flex-nowrap justify-items-center tc w-80'>
                <p className='tl mh2 mv2 f3 f5-ns'>
            ...
            <div className='db ma mh1 mv3 f3 f5-ns b dark-gray w-80' ref={postRef}>Create a new post</div>
            <div className='db ma flex-row flex-nowrap justify-items-center tc w-80'>
                <p className='tl mh2 mv2 f3 f5-ns'>
            ...
            <div className='db ma mh1 mv3 f3 f5-ns b dark-gray w-80' ref={commentRef}>Comment on the post</div>
            <div className='db ma flex-row flex-nowrap justify-items-center tc w-80'>
                <p className='tl mh2 mv2 f3 f5-ns'>
            ...
            <div className='db ma mh1 mv3 f3 f5-ns b dark-gray w-80' ref={searchRef}>Search for the created post</div>
            <div className='db ma flex-row flex-nowrap justify-items-center tc w-80'>
                <p className='tl mh2 mv2 f3 f5-ns'>
