        ...
        <div id="profile-container" className='pv7 tc f1'>
            ...
            <div>
                ...
                <p className='tl ml3 mv4 f3'>
                    ...
                    In my undergraduate, I was in Visual Media Laboratory at University of Tsukuba. I was doing researh on medical imaging. Here's a 
                    ...
                    I also have some experience of Software Development at SFSU. The detai is in Project section.<br/>
                    I am familiar with technologies such as Pytorch, Tensorflow, Numpy, Pandas, Scikit-Learn, React, and Node.js
                </p>
                <p className='tl ml3 mv4 f3'>
                    As a fast learner and a motivated person, I can adapt to any challenges without problems.<br/>
                    I went through and overcame some difficult situations with a resolute and invincible sprit, so I am well-prepared to tackle challenges and maximie my ability.
                </p>
            </div>
        </div>
    )
