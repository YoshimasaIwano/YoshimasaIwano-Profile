...
const ImgData9: ImageDataProps = {
  ...
  description:
    'This is a picture of the first sunrise in the year from the top of Mt.Tsukuba. (Japan)'
};
...
const ImgData11: ImageDataProps = {
  ...
  description:
    'This is a picture of San Froncisco Down Town fron a cruise. (USA)'
};
...
const ImgData20: ImageDataProps = {
  ...
  description:
    'This is a picture of a fall with rainbow at Yosemite National Park. (USA)'
};
