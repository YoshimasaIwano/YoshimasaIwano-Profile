...
const hiraganaClassifierProps: ProjectProps = {
  ...
  overview:
    'The purpose of this team project is to create an image classifier web app.',
...
const csc868Props: ProjectProps = {
  ...
  overview:
    'The purpose of this team project is to develop a trader app with agile devlopment in a team.',
  period: '(2022 Fall)',
  tools: [
    'JavaScript',
    'MySQL',
...
const csc600Props: ProjectProps = {
  ...
  overview:
    'The purpose of this course is to create a musical instrument and a visualizer.',
  period: '(2022 Spring)',
...
function ProjectContent({
  ...
  return (
    ...
    >
      ...
      <div className="w-auto tc word-wrap f4 f6-ns b dark-pink mh1 mv1">
        {title}
      </div>
      ...
      <div className="mh2 mv1 f5 f7-ns flex flex-wrap items-center justify-start">
        {tools.map((tool) => {
          return (
            <div className="tc mv1 mh2 w-auto mh0 br2 hover-bg-blue" key={tool}>
              {tool}
            </div>
          );
        })}
