...
export function Resume() {
  ...
  return (
    ...
    >
      ...
      <div className="mv3">
        <a
          className="no-underline b mv3 mh3 ph2 f3 f5-ns dark-green bg-navy hover-yellow hover-bg-green br2 "
          href="./resume[YoshimasaIwano].pdf"
          download="./resume[YoshimasaIwano].pdf"
        >
          Download My Resume
        </a>
        <div className="ma">
