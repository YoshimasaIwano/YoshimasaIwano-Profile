...
const imageArray: Array<string> = [metallophone, searchSong];
    ...
    >
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          The purpose of this project is to create a musical instrument and
          visualizer, then work on plylist database as a team.
        </p>
      </div>
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          I created a metallophone, which produces different sounds according to
          keys.
        </p>
      </div>
      <div
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          I created a visualizer, which shows 2D waveform. X axis expresses the
          length of sounds, while gray scale indicates pitch of sound. In other
          words, high pitch sound is white and low pitch sound is black.
        </p>
      </div>
      <img
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          I worked on creating playlist database, which has a song name and
          artist name. I added the searching function that uses both song names
          and artist names.
        </p>
        <img
          className="db ma mv3 w-50 h-50 w-80-ns h-80-ns pointer"
