...
export function CSC868() {
  ...
  const scrollToUserDashboard = () =>
    userDashboardRef.current?.scrollIntoView({
      behavior: 'smooth'
    });
  const scrollToMyResponsibility = () =>
    myResponsibilityRef.current?.scrollIntoView({
      behavior: 'smooth'
    });
  ...
  return (
    ...
    >
      ...
      <div className="tl f2 f4-ns b ml1 mv1">
        CSC868 Trader App Team Project
      </div>
      <div className="db ma br4 flex-row flex-nowrap justify-items-center tc bg-white-50 w-70 w-100-ns">
        ...
        <button
          className="mh2 mv1 br3 bn tl bg-white-50 f4 f6-ns w-50 w-80-ns pointer"
          onClick={scrollToUserDashboard}
        >
          ・User Dashboard
        </button>
        <button
          className="mh2 mv1 br3 bn tl bg-white-50 f4 f6-ns w-50 w-80-ns pointer"
          onClick={scrollToMyResponsibility}
        >
          ・My Responsibility
        </button>
        <button
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          The purpose of this project is to implement a trader web application
          with agile development in a team. <br />
        </p>
        <p className="tl mh2 mv2 f3 f5-ns">
          Here is the links for
          <a
            className="no-underline b white hover-light-yellow"
            href="https://github.com/YoshimasaIwano/csc868-team7"
          >
            {' '}
            Github{' '}
          </a>
        ...
        <p className="tl mh2 mv2 f3 f5-ns">
          In terms of techniques, I learned a lot about backend skills such as
          EC2 of AWS and MySQL. <br />
          Also, I realized the importance of communication in a team project. I
          am the most experienced student among the other team members, so I
          helped them set up the development environment and told them how to
          learn new tools.
        </p>
      </div>
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          When you enter a search word and hit the search button, you will see
          the matched results within the sepecified category. There are 6
          categories, All, Videos, Images, Music, Ebooks, and Slides. If there
          are no results, you will see all posts.
          <br />
          There is also a validation for search words. If you enter
          non-alphanumeric characters, you will get an error message and cannot
          search.
        </p>
        <div className="flex">
          <img
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          If you like a post, you can contact the owner by clicking the contact
          seller button. You will transform to the page for the detail of the
          item. You can send a message to the owner at the bottom. <br />
        </p>
        <img
          className="db ma mv3 w-50 h-50 pointer"
          src={message}
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          In the register form, you should enter full name, SFSU email, and
          password. You need to follow the rules. For example, you can only use
          SFSU and a password shall be at least one lower case, one upper case
          and one degit.
        </p>
        <img
          className="db ma mv3 w-50 h-50 pointer"
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          In login form, you should enter your email and password. If you forget
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          In post form, you need to enter title, category, price, and
          description and upload the file you want to sell. If you are not
          logged in or registered, the login page is poped up.
        </p>
        <img
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          You can check pending posts and posted posts, and messages. You can
          also reply the message.
        </p>
        <img
          className="db ma mv3 w-50 h-50 w-80-ns h-80-ns pointer"
          src={userDashboard}
      ...
      <div
        className="db ma mh1 mv3 f3 f5-ns b dark-gray w-80"
        ref={myResponsibilityRef}
      >
        My Responsibility
      </div>
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          I am a Github master and my role is to check code review and approve
          all pull requests. I told all team members to follow the constant code
          convention. I gained the experience of code and task management from
          this project.
        </p>
      </div>
      <div
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          1. All members are not at the same level of familiarity with tools we
          used in this project. <br />
          So, I shared some tutorial videos and documents. If a member struggled
          with the problem even after that, I helped them fix it giving how to
          find a solution. In other situations, team members helped me, too.
          That is how we learned from each other.
        </p>
        <p className="tl mh2 mv2 f3 f5-ns">
          2. I learned the importance of communication in team project. <br />
          We need a weekly meeting, but it's hard for everyone to join it all
          the time, so elaborated comments in code are very helpful to
          supplement the lack of communication. I can see what they have done
          why they have done in that way.
        </p>
      </div>
    </motion.div>
  );
