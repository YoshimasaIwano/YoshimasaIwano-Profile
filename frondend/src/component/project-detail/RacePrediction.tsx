...
const imageArray: Array<string> = [resultsImage, heatmapImage];
...
export function RacePrediction() {
  ...
  const scrollToWebScraping = () =>
    webScrapingRef.current?.scrollIntoView({
      behavior: 'smooth'
    });
  const scrollToDataCleaning = () =>
    dataCleaningRef.current?.scrollIntoView({
      behavior: 'smooth'
    });
  const scrollToModel = () =>
  ...
  return (
    ...
    >
      ...
      <div className="db ma br4 flex-row flex-nowrap justify-items-center tc bg-white-50 w-70 w-100-ns">
        ...
        <button
          className="mh2 mv1 br3 bn tl bg-white-50 f4 f6-ns w-50 w-80-ns pointer"
          onClick={scrollToWebScraping}
        >
          ・Web Scraping
        </button>
        <button
          className="mh2 mv1 br3 bn tl bg-white-50 f4 f6-ns w-50 w-80-ns pointer"
          onClick={scrollToDataCleaning}
        >
          ・Data Cleaning
        </button>
        <button
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          The motivation is I want to apply my knowledge of machine learning to
          real world problems.
        </p>
        <p className="tl mh2 mv2 f3 f5-ns">
          Here is
          <a
            ...
            href="https://github.com/YoshimasaIwano/Race-Prediction"
          >
            {' '}
            Github Repository
          </a>
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          ...
          <a
            className="no-underline b white hover-light-yellow"
            href="https://www.netkeiba.com/"
          >
            {' '}
            netkeiba{' '}
          </a>
          to collect race and horse data.
          <br />I collected around 20000 race data from 1986 to 2022 and around
          63000 horse data, who raced in JRA.
        </p>
      </div>
      <div
        className="db ma mh1 mv3 f3 f5-ns b dark-gray w-80"
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          ・Get URL
          <br />
          &ensp; Using webdriver of Selenium, I can access netkeiba.com and
          collect the urls of race and horse data pages, and save them in each
          folder. <br />
          ・Get HTML
          <br />
          &ensp; Using Requests and urls I got from the previous step, I got
          HTML files and save them in a folder.
          <br />
          ・Create data csv
          <br />
          &ensp; Using BeautifulSoup and htmls, I created raw race and horse
          data csv files.
        </p>
      </div>
      <div
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          Initially, there's a lot of columns of which value is a string, so I
          have to convert them into numbers. <br />I added other features such
          as the resutls of the last 3 races and pedigree information.
        </p>
      </div>
      <div className="db ma mh1 mv3 f3 f5-ns b dark-gray w-80" ref={modelRef}>
        Model
      </div>
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          ・ResRace
          <br />
          &ensp; ResRace is based on Resnet, which has skipping connections to
          make layers deeper.
          <br />
          ResRace predicts the order of each horse in a race, so it might
          predict multiple horses in a race are the first. (Winner) <br />
          ・TransRace
          <br />
          &ensp; TransRace is based on Transformer, which has self-attention
          architechture to pay attention to the relation between horses. <br />
          By making use of the advantage of time-sequential data structure,
          TransRace predicts identical orders in a race.
        </p>
      </div>
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          Before evaluating the models, I split the data into train and
          validation with 99:1, so I used 202 race data, which contain 4848
          predictions. <br />
          Here is the summary of the results. Speaking to winner, Precision is
          0.188, Recall is 0.22, and F-1 score is 0.203.
          <br />
