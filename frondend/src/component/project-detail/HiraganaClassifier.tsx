...
const JavaScriptProps: ToolProps = {
  name: 'JavaScript',
  description:
    "JavaScript is the world's most poplar programming language. It is the language of Web."
};

const FlaskProps: ToolProps = {
  name: 'Flask',
  description:
    'Flask is considered more pythonic than Django web framework because in common situations the equivalent Flask web application is more explicit.'
};
    ...
    >
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          The motivation is I want to work on team project, so this web
          application is created with my friend during thanksgiving week in
          2022. I want to create a web app using both deeplearning knowledge and
          software engineering skills and deploy it on AWS.
        </p>
        <p className="tl mh2 mv2 f3 f5-ns">
          Here is
          <a
            className="no-underline b white hover-light-yellow"
            href="https://hiraganaclassifier.net/"
          >
            {' '}
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          I used Flask for backend, CSS/JS and Bootstrap for frontend, and
          tensorflow for image classification model.
          <br />
          Specifically, the drawing squre is implemented by CreateJS and popup
          image of all hiragana is implemented by luminousJS. The classification
          model is based on EfficientNetb0 by fine-tuning.
        </p>
        <p className="tl mh2 mv2 f3 f5-ns">
      ...
      <div className="db ma flex-row flex-nowrap justify-items-center tc w-80">
        <p className="tl mh2 mv2 f3 f5-ns">
          When you draw a hiragana on the white square box, then click the
          predict button, the image will be sent to the server and the model
          will return the predicted label and the confidence. <br />
